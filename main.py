...
<!--            <p class="d-inline-flex gap-1">-->
            ...
            <div class="collapse" id="collapseExample">
              <div class="card card-body">
                Выберите товар и оплатите удобным для Вас способом
              </div>
            </div>
            ...
            <div class="collapse" id="collapseExample2">
              <div class="card card-body">
                Гарантия сроком 6 месяцев, при наличии товарного и кассового чека.
              </div>
            </div>
        </main>
        ...
        <main class="row">
            <div class="row text-center">
                <p class="fs-5 text-body-secondary">Таблица товаров</p>
            </div>
            <table class="table">
              <thead>
                <tr>
